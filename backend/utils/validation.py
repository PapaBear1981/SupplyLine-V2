...
CHEMICAL_SCHEMA = {
    ...
    "optional": ["description", "manufacturer", "location", "expiration_date", "msds_url", "category", "status", "minimum_stock_level", "notes", "warehouse_id", "chemical_part_id"],
    "types": {
        "part_number": str,
        "lot_number": str,
        "quantity": (int, float),
        ...
        "notes": str,
        "warehouse_id": int,
        "chemical_part_id": int
    },
    "constraints": {
        "part_number": {"max_length": 100},
        "lot_number": {"max_length": 100},
        "quantity": {"min": 0},
        "unit": {"choices": ["each", "oz", "ml", "l", "g", "kg", "lb", "gal", "tubes", "tube", "can", "cartridge", "gallon", "kit", "quart", "roll"]},
        "description": {"max_length": 500},
